            ...
            <div class="row flex-row-reverse">
                  ...
                  <div class="col-md-6 wow fadeInUp">
                    <div class="iq-blog-box">
                      ...
                      <div class="iq-blog-detail">
                        ...
                        <div class="blog-title">
                          <h4 class="entry-title">
                            <a href="blog-details.html"> Build Construction </a>
                          </h4>
                        </div>
                        <div class="blog-content">
                          <p>
                  ...
                  <div class="col-md-6 wow fadeInUp">
                    <div class="iq-blog-box">
                      ...
                      <div class="iq-blog-detail">
                        ...
                        <div class="blog-title">
                          <h4 class="entry-title">
                            <a href="blog-details.html"> Life Lack Meaning </a>
                          </h4>
                        </div>
                        <div class="blog-content">
                          <p>
                  ...
                  <div class="col-md-6 wow fadeInUp">
                    <div class="iq-blog-box">
                      ...
                      <div class="iq-blog-detail">
                        ...
                        <div class="blog-title">
                          <h4 class="entry-title">
                            <a href="blog-details.html"> Content Marketing </a>
                          </h4>
                        </div>
                        <div class="blog-content">
                          <p>
                    ...
                    <div class="pagination justify-content-center">
                      <nav aria-label="Page navigation">
                        <ul class="page-numbers">
                          ...
                          <li>
                            <a class="next page-numbers" href="#?paged=2'">
              ...
              <div class="col-lg-4 col-sm-12 sidebar-service-right mt-5 mt-lg-0">
                <div id="secondary" class="widget-area">
                    ...
                    >
                      ...
                      <div class="testimonial-info">
                        <p>
                          ...
                          sit voluptatem accusantium incididunt ut labore et
                          dolore Sed ut perspiciatis error. Perspiciatis unde
                          omnis iste.&#8221;
                        </p>
                        <div class="post-img">
                          <img
                          ...
                          <div class="post-img">
                            ...
                            <div class="post-blog">
                              <div class="blog-box">
                                ...
                                <a class="new-link" href="blog-details.html">
                  ...
                  <div
                    id="categories-4"
                    class="widget widget_categories wow fadeInLeft"
                  >
                    <h2 class="widget-title">Categories</h2>
                    <ul>
                      <li class="cat-item cat-item-3">
                        <a href="#">CSS</a> <span class="post_count"> 2 </span>
                      </li>
                      <li class="cat-item cat-item-2">
                        <a href="#">Design</a> <span class="post_count"> 2 </span>
                      </li>
                      <li class="cat-item cat-item-4">
                        <a href="#">HTML</a> <span class="post_count"> 2 </span>
                      </li>
                      <li class="cat-item cat-item-1">
                        <a href="#">Uncategorized</a>
                        <span class="post_count"> 1 </span>
                      </li>
                    </ul>
                  </div>
                </div>
