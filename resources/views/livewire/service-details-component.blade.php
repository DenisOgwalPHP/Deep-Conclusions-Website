                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="iq-portfolio-image"> <img width="1260" height="954" src="{{ asset('assets/images/about-us/01.png') }}" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""> </div>
                        </div>
                    ...
                    <div class="row ">
                        <div class="col-sm-12">
                            <div class="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="true" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-autoplay="true" data-loop="true" data-margin="30">
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/01.png') }}" alt="slider"></div>
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/02.png') }}" alt="slider"></div>
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/03.png') }}" alt="slider"></div>
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/05.png') }}" alt="slider"></div>
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/01.png') }}" alt="slider"></div>
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/02.png') }}" alt="slider"></div>
                                <div class="Consulting-img  text-left"><img src="{{ asset('assets/images/about-us/03.png') }}" alt="slider"></div>
                            </div>
                        ...
                        <div class="col-sm-12 mt-5">
                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed
                                to using ‘Content here, content here’, making it look like readable English. Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.</p>
                        </div>
                        <div class="col-sm-12 no-margin">
                            <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable. If you are going to use
